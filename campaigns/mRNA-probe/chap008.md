...
- The Doomborgs start investigating what could be inside the [Frostbreaker](../../directory/Doomborgs/Frostbreaker.md). It seems like an invisible alien.
- [Oni](../../directory/Doomborgs/Oni.md) quickly checks all possible sensors and decide to go with a thermal sensor to detect friction. It seems that an alien creature is touching all aspects of the starship.
...
- The crew thinks about their options and decide to set up a trap, moving the metal egg to one of the escape pods. [Olaf](../../directory/Doomborgs/Olaf.md) and [Oliver Bennet](../../directory/Doomborgs/Oliver.md) execute the plan. Unfortunately the Metaliano does not fall into the trap.
...
- With the reactor repaired, Olaf decides to speak with [John McLeod](../../directory/TharsisMining/JohnMcLeod.md). The manager does not seem interested in helping the crew, and sees an opportunity for them dying and [Tharsis Mining](../../directory/TharsisMining/index.md) not having to pay for the complete mission.
- He does commend the crew on their tactics of bringing a terrorist to Perdurabo.
- After landing in [index](../../directory/Defiance/index.md), Olaf reports the alien to the ICO, and [Eliana Murovec](../../directory/haruna/ElianaMurovec.md) pays the crew for her transport.
