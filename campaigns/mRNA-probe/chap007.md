...
- Inside the pod is [Sabaka](../../directory/Doomborgs/Sabaka.md), unconscious. There is also a significant amount of transparent and reflective goo.
- A technician takes the goo to the station laboratory for study.
- Sakaba is taken to the infirmary, where they are evaluated. [Oliver](../../directory/Doomborgs/Oliver.md) Bennet helps Dr [SuyinIndrani](../../directory/Perdurabo/SuyinIndrani.md) and finds a metallic object inside Sabaka's anus. Sabaka wakes up as the object is being removed.
- [Olaf](../../directory/Doomborgs/Olaf.md) and [Oni](../../directory/Doomborgs/Oni.md) go to the [Frostbreaker](../../directory/Doomborgs/Frostbreaker.md) to study the egg like metallic object.
- Bennet stays in the infirmary with Sabaka and [Danny](../../directory/Doomborgs/Danny.md), who were recovering from the [PopperSwarm](../../statblocks/PopperSwarm.md) attack.
...
- Olaf speaks with [RolandLomax](../../directory/Perdurabo/RolandLomax.md) and take the documentations that would expose Dutta from Roland's hands. Roland is ok with it, feeling it is the best route of action.
- Oni quickly parse these documents and finds:
	- Embezzlement of [YashDutta](../../directory/Perdurabo/YashDutta.md), who stole money during the construction of Brightside, alonside the son of one of the private minor investors.
	- Purchase orders from [Pacific Metals](../../directory/PM/index.md) for shipment of Novium - which might explain the fact the the station was not meeting Haruna's production quotas.
	- MoU with [makita](../../directory/makita.md)'s subsidiary for ice mining rights - although the two companies are competitors and such an extraction agreement would not be allowed in the new space law from the [ico](../../directory/ico.md).
...
- [ElianaMurovec](../../directory/haruna/ElianaMurovec.md) and her bodyguard leave the transport
...
- Eliana is flabbergast, and after thinking of her options, she offers to pay Olaf to take her back to [Solomons](../../directory/Solomons.md).
- Olaf explains he needs to discuss it with his crew first, and leaves the pod.

![](https://i.imgur.com/q6m1Pir.png)

**Conversation with [CassianVireo](../../directory/lebkuchen/CassianVireo.md)**
...
- Before they leave, Bennet, Danny and Sabaka go to the Midnight Sun bar and speak with [MarionHardlee](../../directory/Perdurabo/MarionHardlee.md). Marion confirms Cassian was never an employee on the bar. The crew decides to leave her behind, and it would be too risky to confront her now.
...
- It will be an uncomfortable week travelling to [index](../../directory/Defiance/index.md), packed inside the citadel, with 2 additional people, and maybe *something* outside...
